...
public class CardGameGUI extends JFrame implements ActionListener {
		...
		for (int k = 0; k < board.size(); k++) {
			...
			if (imageURL != null) {
				...
				throw new RuntimeException(
					"activity2.Card image not found: \"" + cardImageFileName + "\"");
			}
		}
	 ...
	 *
	 * @param c activity2.Card to get the image for
	 * @param isSelected flag that indicates if the card is selected
	 * @return String representation of the image
	 */
	private String imageFileName(Buggy1.Card c, boolean isSelected) {
		String str = "cards/";
		if (c == null) {
